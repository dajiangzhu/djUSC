...
public class ESL_ExploreTemplate_AnalyseVR {
	...
	public static void main(String[] args) {
		if (args.length == 7) {
			ESL_ExploreTemplate_AnalyseVR mainHandler = new ESL_ExploreTemplate_AnalyseVR();
			...
			mainHandler.ESL_OutPutDir = args[6].trim();
			...
			System.out
					.println("Input: optDicIndex (0-399), dicSize(400), subStartID(1-58), subEndID(10-68), voteRateThreshold(0.5), pValueThreshold(0.5) and ESL_OutPutDir");
